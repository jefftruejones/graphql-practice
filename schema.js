...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        ...
        restaurant: {
            ...
            resolve (parentValue, args){
                return axios.get(`http://localhost:4200/restaurants/${args.id}`).then(res => res.data)
            }
        },
        customers: {
            type: GraphQLList(Customer),
            resolve(parentValue, args){
                return axios.get(`http://localhost:4200/customers`).then(res => res.data);
            }
        },
        customer:{
            type: Customer,
            ...
            resolve(parentValue, args){
                return axios.get(`http://localhost:4200/customers/${args.id}`).then(res => res.data);
            }
        },
        orders: {
